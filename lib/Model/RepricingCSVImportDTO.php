...
class RepricingCSVImportDTO implements ArrayAccess
{
    ...
    const STATE_ERROR_DUPE_SKU = 'ERROR_DUPE_SKU';
    const STATE_ERROR_MAX_ROW_COUNT_EXCEEDED = 'ERROR_MAX_ROW_COUNT_EXCEEDED';
    ...
    public function getStateAllowableValues()
    {
        return [
            ...
            self::STATE_ERROR_DUPE_SKU,
            self::STATE_ERROR_MAX_ROW_COUNT_EXCEEDED,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = ["NEW", "IN_PROGRESS", "DONE", "ERROR_DOWNLOAD", "SKIPPED", "ERROR", "ERROR_NUMBER_FORMATTING", "ERROR_DUPE_SKU", "ERROR_MAX_ROW_COUNT_EXCEEDED"];
        if (!in_array($this->container['state'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'state', must be one of 'NEW', 'IN_PROGRESS', 'DONE', 'ERROR_DOWNLOAD', 'SKIPPED', 'ERROR', 'ERROR_NUMBER_FORMATTING', 'ERROR_DUPE_SKU', 'ERROR_MAX_ROW_COUNT_EXCEEDED'.";
        }
    ...
    {
        $allowed_values = array('NEW', 'IN_PROGRESS', 'DONE', 'ERROR_DOWNLOAD', 'SKIPPED', 'ERROR', 'ERROR_NUMBER_FORMATTING', 'ERROR_DUPE_SKU', 'ERROR_MAX_ROW_COUNT_EXCEEDED');
        if (!is_null($state) && (!in_array($state, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'state', must be one of 'NEW', 'IN_PROGRESS', 'DONE', 'ERROR_DOWNLOAD', 'SKIPPED', 'ERROR', 'ERROR_NUMBER_FORMATTING', 'ERROR_DUPE_SKU', 'ERROR_MAX_ROW_COUNT_EXCEEDED'");
        }
