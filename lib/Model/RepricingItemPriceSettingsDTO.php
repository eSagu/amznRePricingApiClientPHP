...
class RepricingItemPriceSettingsDTO implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = ["UNDEFINED", "FIXED_PRICE", "OPTIMIZATION", "DISABLED", "BUY_BOX", "CUSTOM_CODE"];
        if (!in_array($this->container['mode'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'mode', must be one of 'UNDEFINED', 'FIXED_PRICE', 'OPTIMIZATION', 'DISABLED', 'BUY_BOX', 'CUSTOM_CODE'.";
        }
    ...
    {
        $allowed_values = array('UNDEFINED', 'FIXED_PRICE', 'OPTIMIZATION', 'DISABLED', 'BUY_BOX', 'CUSTOM_CODE');
