...
class RepricingBuyBoxSettingsApi
{
     ...
     * @return \eSagu\Amzn\RePricing\V1\Model\RepricingBuyBoxSettingsDTO[]
     */
     ...
     *
     * @throws \eSagu\Amzn\RePricing\V1\ApiException on non-2xx response
     * @return array of \eSagu\Amzn\RePricing\V1\Model\RepricingBuyBoxSettingsDTO[], HTTP status code, HTTP response headers (array of strings)
     */
    public function callListWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\eSagu\Amzn\RePricing\V1\Model\RepricingBuyBoxSettingsDTO[]',
                '/buy-box-settings'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\eSagu\Amzn\RePricing\V1\Model\RepricingBuyBoxSettingsDTO[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\eSagu\Amzn\RePricing\V1\Model\RepricingBuyBoxSettingsDTO[]', $e->getResponseHeaders());
     ...
     *
     * @param \eSagu\Amzn\RePricing\V1\Model\RepricingBuyBoxSettingsDTO $body  (optional)
     * @throws \eSagu\Amzn\RePricing\V1\ApiException on non-2xx response
     * @return void
     */
